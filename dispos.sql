...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2020 at 09:36 AM
...
(4, 3, 'testing form', 1, 1, '2019-11-04 05:11:04', '2019-11-04 05:18:36', NULL);
...
CREATE TABLE `questions` (
  ...
  `update_options` tinyint(1) NOT NULL,
  `sort` int(11) NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Manju', 'C5099941', 1, 'manju.dn@conduent.com', '2019-12-18 07:38:01', 'E0hiWE7JvRU3vIbHxwwaxL1j0QqK4V2FaHc7nwMpmDtk3qBmmtkvPeydmqm6', NULL, NULL, '0000-00-00 00:00:00'),
