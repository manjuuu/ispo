...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ mix(env('APP_FOLDER').'/css/app.css') }}">
    <link rel="stylesheet" href="{{ mix(env('APP_FOLDER').'/css/library.css') }}">
  ...
  <body>
    ...
    <script src="{{ mix(env('APP_FOLDER').'/js/app.js') }}"></script>
    <script src="{{ mix(env('APP_FOLDER').'/js/library.js') }}"></script>
    @if(session('message'))
      <script>
      swal({
