...
class ResponseController extends Controller
{
    ...
    //to prod
        ...
        if(empty($data1) || empty($data2) || empty($data3) || empty($data4) || empty($data5) || empty($data6) || empty($data7) || empty($data8) || empty($data9) || empty($data10) || empty($data11) || empty($data12) || empty($data13) || empty($data14) || empty($data15) || empty($data16) || empty($data17) || empty($data18) || empty($data19)  ){
